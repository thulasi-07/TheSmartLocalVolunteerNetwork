...
const AppRoutes = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/register-volunteer" element={!user ? <RegisterVolunteer /> : <Navigate to="/" replace />} />
      <Route path="/register-organizer" element={!user ? <RegisterOrganizer /> : <Navigate to="/" replace />} />
