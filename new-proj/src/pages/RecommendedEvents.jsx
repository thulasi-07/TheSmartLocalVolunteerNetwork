    ...
    <div className="p-6 max-w-3xl mx-auto bg-white rounded-xl shadow-lg space-y-6">
      ...
      {recommendation?.match ? (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {recommendation.recommendedEvents.map((event, idx) => (
              <div
                key={idx}
                className="p-4 bg-green-100 border border-green-300 rounded-lg shadow-sm"
              >
                ...
                <ul className="text-sm text-green-700 list-disc ml-5 space-y-1">
                  <li>Skill Score: {event.volunteer_skill_score}</li>
                  <li>Difficulty Level: {event.event_difficulty_level}</li>
                  <li>Experience: {event.volunteer_experience_years} years</li>
                  <li>Distance: {event.distance_km} km</li>
                  <li>Available Hours: {event.availability_hours} hrs</li>
                </ul>
              </div>
            ))}
          </div>
